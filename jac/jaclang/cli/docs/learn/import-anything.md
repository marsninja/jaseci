---
name: learn/import-anything
description: Jac compiles one source file to three targets -- Python bytecode, JavaScript, and native machine code. Each target is a codespace, and each codespace brings its own ecosystem:
source: docs/docs/quick-guide/import-anything.md
---
