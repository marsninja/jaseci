---
name: learn/syntax-cheatsheet
description: This page is a lookup reference, not a learning guide. For hands-on learning, start with the AI Day Planner tutorial which teaches these concepts progressively.
source: docs/docs/quick-guide/syntax-cheatsheet.md
---
