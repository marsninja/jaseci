---
name: learn/project-kinds
description: Jac compiles one language to three runtimes -- Python bytecode (server, sv), JavaScript (client, cl), and native machine code (na, which also compiles to in-browser WebAssembly) -- ...
source: docs/docs/quick-guide/project-kinds.md
---
