---
name: tutorial/ai/mcp-quickstart
description: Connect your AI coding assistant to the live Jac compiler in five minutes. The built-in jac mcp server exposes ~19 tools (validate, lint, run, transpile, explain errors, search ...
source: docs/docs/tutorials/ai/mcp-quickstart.md
---
