---
name: tutorial/ai/agentic
description: The previous tutorials showed LLMs generating text and extracting structured data. But what happens when the LLM needs information it doesn't have -- like the current time, a ...
source: docs/docs/tutorials/ai/agentic.md
---
