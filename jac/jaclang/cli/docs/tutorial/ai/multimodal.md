---
name: tutorial/ai/multimodal
description: Modern vision-capable LLMs (like GPT-4o and Gemini) can understand images and videos alongside text. byLLM integrates this capability through the Image and Video types -- you pass ...
source: docs/docs/tutorials/ai/multimodal.md
---
