---
name: tutorial/extend/publish-a-library
description: Build a reusable library in Jac and ship it to PyPI as a wheel and to npm as a package -- from jac create to twine upload. The publishing reference documents every knob; this ...
source: docs/docs/tutorials/extend/publish-a-library.md
---
