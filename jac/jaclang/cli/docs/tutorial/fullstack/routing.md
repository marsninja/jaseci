---
name: tutorial/fullstack/routing
description: When your application grows beyond a single view, you need routing -- the ability to map URLs to different pages or views within your app. Jac-client supports client-side routing ...
source: docs/docs/tutorials/fullstack/routing.md
---
