---
name: tutorial/fullstack/components
description: Jac's client-side code uses JSX syntax (the same HTML-in-code approach popularized by React) to build UI components. Components are functions declared in client-side code -- a ...
source: docs/docs/tutorials/fullstack/components.md
---
