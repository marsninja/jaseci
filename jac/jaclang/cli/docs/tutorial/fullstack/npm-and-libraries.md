---
name: tutorial/fullstack/npm-and-libraries
description: Jac's client-side compiler gives you full access to the npm ecosystem. You can import React hooks, UI component libraries, utility packages, and any other npm module directly into ...
source: docs/docs/tutorials/fullstack/npm-and-libraries.md
---
