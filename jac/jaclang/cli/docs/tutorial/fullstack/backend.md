---
name: tutorial/fullstack/backend
description: The real power of Jac's full-stack model is how seamlessly client components connect to server logic. Instead of manually defining REST endpoints, writing fetch calls, and parsing ...
source: docs/docs/tutorials/fullstack/backend.md
---
