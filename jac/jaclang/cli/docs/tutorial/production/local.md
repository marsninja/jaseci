---
name: tutorial/production/local
description: During development, jac run executes your program and exits. But production applications need to stay running and respond to HTTP requests from browsers, mobile apps, or other ...
source: docs/docs/tutorials/production/local.md
---
