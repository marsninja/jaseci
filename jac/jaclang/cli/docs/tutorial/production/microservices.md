---
name: tutorial/production/microservices
description: A Jac codebase can run as a single monolith or as several independently-deployed microservices, with no source changes between the two. The trick is the sv import keyword: when ...
source: docs/docs/tutorials/production/microservices.md
---
