---
name: tutorial/first-app/build-ai-day-planner
description: In this tutorial, you'll build a full-stack AI day planner from scratch -- a single application that manages daily tasks (auto-categorized by AI) and generates meal shopping lists ...
source: docs/docs/tutorials/first-app/build-ai-day-planner.md
---
