---
name: tutorial/language/basics
description: This tutorial covers the core syntax and concepts you need to start writing Jac programs. If you're coming from Python, most things will look familiar -- Jac compiles to Python ...
source: docs/docs/tutorials/language/basics.md
---
