---
name: tutorial/language/coding_primer
description: > Welcome to Programming! This guide will teach you how to program using Jac as your first programming language. No prior experience required. We'll start from the absolute basics ...
source: docs/docs/tutorials/language/coding_primer.md
---
