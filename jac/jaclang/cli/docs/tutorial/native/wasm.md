---
name: tutorial/native/wasm
description: Compile Jac's native (na) subset to WebAssembly and run it in the browser at native speed -- with Jac's own wasm linker, no emscripten, no wasm-ld, no toolchain to install.
source: docs/docs/tutorials/native/wasm.md
---
