---
name: tutorial/native/chess
description: > Prerequisites: Familiarity with Native Compilation basics -- na { } blocks (or .na.jac files) and with entry {}.
source: docs/docs/tutorials/native/chess.md
---
