---
name: ref/plugins/jac-desktop
description: The desktop target (historically the standalone jac-desktop plugin, now built into jaclang core) adds a Jac-native desktop build to full-stack Jac apps. A desktop app is one jac ...
source: docs/docs/reference/plugins/jac-desktop.md
---
