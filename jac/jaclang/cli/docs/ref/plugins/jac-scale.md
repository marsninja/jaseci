---
name: ref/plugins/jac-scale
description: Scale generates REST endpoints from your Jac walkers and functions. Running jac start turns every :pub or :priv walker into an API endpoint backed by FastAPI, with automatic ...
source: docs/docs/reference/plugins/jac-scale.md
---
