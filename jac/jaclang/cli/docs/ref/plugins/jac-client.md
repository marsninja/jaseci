---
name: ref/plugins/jac-client
description: jac-client adds client-side compilation to Jac so you can write React-style UI components using cl { } blocks (or .cl.jac files). The compiler separates your code automatically -- ...
source: docs/docs/reference/plugins/jac-client.md
---
