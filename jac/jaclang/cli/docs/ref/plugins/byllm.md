---
name: ref/plugins/byllm
description: byLLM lets you delegate function implementations to large language models. You declare a function signature -- its name, parameter names, and types -- append by llm, and the LLM ...
source: docs/docs/reference/plugins/byllm.md
---
