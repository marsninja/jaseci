---
name: ref/persistence
description: Jac apps persist their object-spatial graph automatically. Anything reachable from root survives across runs -- but the schema of your node/obj/edge/walker archetypes inevitably ...
source: docs/docs/reference/persistence.md
---
