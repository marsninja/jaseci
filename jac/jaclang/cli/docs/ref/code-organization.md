---
name: ref/code-organization
description: In most programming languages, the interface of a module -- what it exposes -- is interleaved with its implementation -- how it works. Jac takes a fundamentally different approach. ...
source: docs/docs/reference/code-organization.md
---
