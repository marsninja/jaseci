---
name: ref/testing
description: Jac has first-class support for testing built directly into the language. Instead of importing a test framework or following naming conventions, you write test "description" { ... ...
source: docs/docs/reference/testing.md
---
