---
name: ref/plugin-authoring
description: Jaclang no longer has a plugin system. The pluggy-style hook mechanism (pluginmanager, @hookable/@hookspec/@hookimpl, entry-point discovery, JACDISABLEDPLUGINS, the ...
source: docs/docs/reference/plugin-authoring.md
---
