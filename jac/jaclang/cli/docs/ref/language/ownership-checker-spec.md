---
name: ref/language/ownership-checker-spec
description: This is the authoritative statement of what OwnershipCheckPass computes, at what granularity, and what its facts promise. It is the contract document for the compiler's ...
source: docs/docs/reference/language/ownership-checker-spec.md
---
