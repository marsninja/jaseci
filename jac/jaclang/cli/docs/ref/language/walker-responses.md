---
name: ref/language/walker-responses
description: Walkers traverse a graph, visiting nodes and executing logic at each step. But how do you get data out of a walker after it finishes? That's what the report statement is for -- ...
source: docs/docs/reference/language/walker-responses.md
---
