---
name: ref/language/access-modifiers
description: Jac has three access modifiers -- :pub, :protect, and :priv -- written as a tag on a declaration (def:pub, has:priv, walker:protect, glob:protect, ...). They share one intuition ...
source: docs/docs/reference/language/access-modifiers.md
---
