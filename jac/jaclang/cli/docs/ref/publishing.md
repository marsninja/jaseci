---
name: ref/publishing
description: Jac projects publish to PyPI as standard Python wheels -- no pyproject.toml, no setuptools, no build backend. The jac build --as wheel command reads your jac.toml and produces a ...
source: docs/docs/reference/publishing.md
---
