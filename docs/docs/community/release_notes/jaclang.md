...
- **Centralize Type, Hierarchy, and Effect Analysis into Shared Passes**: Extracted redundant analysis logic from the NA and ES backend passes into three new shared compiler passes.
